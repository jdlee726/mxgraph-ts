declare global {
  ...
  let mxResourceExtension: string;
}
...
export const mxResources = {
   ...
   */
  isLanguageSupported: function(lan: string) {
    if (mxClient.languages != null && mxClient.languages.length > 0) {
   ...
   * lan - The current language.
   */
  getDefaultBundle: function(basename: string, lan: string) {
    if (
   ...
   */
  getSpecialBundle: function(basename: string, lan: string) {
   ...
   */
  get: function(key: string, params?: any[], defaultValue?: any) {
   ...
   * to be replaced with in the resulting string.
   */
  replacePlaceholders: function(value: string, params: string[]) {
    var result = [];
    var index = null;
   ...
   */
  loadResources: function(callback: ()=> void) {
