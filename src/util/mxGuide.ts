...
export default class mxGuide {
    ...
    constructor(graph: mxGraph, states: mxCellState[] | null) {
        this.graph = graph;
     ...
     */
    setStates(states: mxCellState[] | null) {
        this.states = states;
    };
     ...
     */
    getGuideTolerance(gridEnabled: boolean) {
     ...
     */
    createGuideShape(horizontal: boolean) {
     ...
     */
    isStateIgnored(state: mxCellState) {
        return false;
    };
     ...
     */
    move(bounds: mxRectangle, delta: mxPoint, gridEnabled: boolean, clone: boolean) {
        if (this.states != null && (this.horizontal || this.vertical) && bounds != null && delta != null) {
            ...
            b.y += delta.y;
            var overrideX = false;
            var stateX: mxCellState | null = null;
            var valueX: number = 0;
            var overrideY = false;
            var stateY: mxCellState | null = null;
            var valueY = 0;
            var ttX = tt;
            var ttY = tt;
            var left = b.x;
     ...
     */
    getDelta(bounds: mxRectangle, stateX: mxCellState | null, dx: number, stateY: mxCellState | null, dy: number) {
     ...
     * Hides all current guides.
     */
    getGuideColor(state: mxCellState | null, horizontal: boolean) {
