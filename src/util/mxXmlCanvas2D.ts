...
import { HTMLElementMore, mxConstants } from "./mxConstants";
...
export default class mxXmlCanvas2D extends mxAbstractCanvas2D {
    ...
    root: HTMLElementMore | null;

    constructor(root: HTMLElementMore | null) {
        super();
