...
export const mxEvent =
{
     ...
     * 
     * ref: [attachEvent和addEventListener区别总结](https://www.cnblogs.com/shytong/p/5105536.html)
	 */
    addListener: function () {
        var updateListenerList = function (element: IMxEventElement, eventName: string, funct: EventHandlerNonNull) {
        ...
        if (window.addEventListener) {
            return function (element: IMxEventElement, eventName: string, funct: EventHandlerNonNull) {
    ...
    removeListener: function () {
        var updateListener = function (element: IMxEventElement, eventName: string, funct: EventHandlerNonNull) {
            if (element.mxListenerList != null) {
	 ...
	 */
    removeAllListeners: function (element: IMxEventElement) {
    ...
    var getState = function (evt: MouseEvent) {
        ...
        mxEvent.addGestureListeners(node, function (evt: MouseEvent) {
            if (down != null) {
                down(evt);
            }
        ...
        mxEvent.addListener(node, 'dblclick', function (evt: MouseEvent) {
            if (dblClick != null) {
                dblClick(evt);
            }
            else if (!mxEvent.isConsumed(evt)) {
	 ...
	 */
    release: function (element: IMxEventElement) {
        try {
            if (element != null) {
                ...
                if (children != null) {
                    ...
                    for (var i = 0; i < childCount; i += 1) {
                        mxEvent.release(children[i] as IMxEventElement);
                    }
                }
            }
        }
	 ...
	 */
    addMouseWheelListener: function (funct: EventHandlerNonNull, target: IMxEventElement) {
        if (funct != null) {
            var wheelHandler = function (evt?: WheelEvent) {
            ...
            if (mxClient.IS_SF && !mxClient.IS_TOUCH) {
                ...
                mxEvent.addListener(target, 'gesturechange', function (evt: WheelEvent) {
                    mxEvent.consume(evt);
                    // @ts-ignore
            ...
            mxEvent.addListener(target, 'wheel', wheelHandler as any);
        }
    },
	 ...
	 */
    disableContextMenu: function (element: IMxEventElement) {
	 ...
	 */
    isConsumed: function (evt: mxMouseEvent | Event) {

        return (evt as mxMouseEvent).isConsumed != null && (evt as mxMouseEvent).isConsumed;
    },
	 ...
	 */
    isLeftMouseButton: function (evt: MouseEvent) {
	 ...
	 */
    isMiddleMouseButton: function (evt: MouseEvent) {
        if ('which' in evt) {
            return evt.which === 2;
        }
        else {
	 ...
	 * true.
	 */
    consume: function (evt: Event, preventDefault = true, stopPropagation = true) {
