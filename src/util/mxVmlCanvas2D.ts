...
export default class mxVmlCanvas2D extends mxAbstractCanvas2D {
 ...
 */
     ...
     * <mxClient.VML_PREFIX>.
     */
    createVmlElement(name: string) {
        return this.createElement(mxClient.VML_PREFIX + ':' + name) as unknown as IPlainObject;
    };
    ...
    addNode(filled: boolean, stroked: boolean) {
        ...
        if (node != null) {
            ...
            if (filled && s.fillColor != null) {
                ...
                String(this.path[this.path.length - 1]) == this.closeOp)) {
            ...
            this.root!.appendChild(node as Node);
        }
    };
    ...
    createTransparentFill() {
        var fill = this.createVmlElement('fill') as IPlainObject;
    ...
    createFill() {
        ...
        var fill = this.createVmlElement('fill') as unknown as IPlainObject;
    ...
    createStroke() {
        var s = this.state;
        var stroke = this.createVmlElement('stroke') as unknown as IPlainObject;
     ...
     */
    createShadow(node: IPlainObject, filled: boolean, stroked: boolean) {
        var s = this.state;
    ...
    rotate(theta: number, flipH: boolean, flipV: boolean, cx: number, cy: number) {
        if (flipH && flipV) {
            ...
            (this.root!.style as IPlainObject).flip = 'x';
        }
        else if (flipV) {
            (this.root!.style as IPlainObject).flip = 'y';
        }
        ...
        (this.root!.style as IPlainObject).rotation = theta;
     ...
     */
    createRect(nodeName: string, x: number, y: number, w: number, h: number) {
        var s = this.state;
     ...
     */
    createDiv(str: string | Node, align: string | null, valign: string | null, overflow: string | null) {
        ...
        if (this.textEnabled && str != null) {
            ...
            if (format == 'html') {
                ...
                if (this.root!.nodeName != 'DIV') {
                    ...
                    this.root!.appendChild(rect as Node);
                }
                else {
                    this.root!.appendChild(abs as Node);
                }
                ...
                if (this.rotateHtml && rot != 0) {
                    ...
                    var tmp2 = sizeDiv.offsetWidth + 3;
     ...
     */
    plainText(x: number, y: number, w: number, h: number, str: string, align: string | null, valign: string | null, wrap: boolean | null, format: string | null, overflow: string | null, clip: boolean | null, rotation: number | null, dir: string | null) {
