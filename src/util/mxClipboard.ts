...
export const mxClipboard =
{
	 ...
	 */
    setCells: function (cells: mxCell[] | null) {
	 ...
	 */
    cut: function (graph: mxGraph, cells: mxCell[] | null) {
	 ...
	 */
    removeCells: function (graph: mxGraph, cells: mxCell[] | null) {
	 ...
	 */
    copy: function (graph: mxGraph, cells: mxCell[] | null) {
        cells = cells || graph.getSelectionCells();
