...
export type TRequestOnloadCallback = (request: mxXmlRequest | mxXmlRequest[]) => void;
export type TRequestOnErrorCallback = () => void;
 ...
 */
    ...
    constructor(url: string, params: string | null, method: ERequestMethod = ERequestMethod.POST, async?: boolean, username?: string, password?: string) {
        this.url = url;
        this.params = params;
        this.method = method;
 ...
 */
     ...
     */
    getText = () => {
        return this.request && this.request.responseText;
    };
     ...
     */
    isReady = () => {
        return this.request && this.request.readyState == 4 || false;
    };
     ...
     */
    send = (onload?: TRequestOnloadCallback, onerror?: TRequestOnErrorCallback, timeout?: number, ontimeout?: XMLHttpRequestEventTarget['ontimeout']) => {
        this.request = this.create!() as XMLHttpRequest;
        ...
        if (this.request != null) {
            ...
            if (window.XMLHttpRequest && this.withCredentials && this.request) {
     ...
     */
    setRequestHeaders = function (request: XMLHttpRequest, params: string | null) {
        if (params != null) {
     ...
     */
    simulate = function (doc = document, target?: string) {
        var old = null;
