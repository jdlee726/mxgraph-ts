...
export default class mxConnector extends mxPolyline {
    constructor(points: mxPoint[], stroke: string | null, strokewidth: number) {
     ...
     * paint the marker.
     */
    createMarker(c: TCanvas2D, pts: mxPoint[], source: boolean) {
        var result = null;
        var n = pts.length;
        ...
        if (type != null && p0 != null && pe != null) {
            ...
            result = mxMarker.createMarker(c, this, type, pe, unitX, unitY, size, source, this.strokewidth as number, filled);
        }
