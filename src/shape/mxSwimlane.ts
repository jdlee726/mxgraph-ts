...
export default class mxSwimlane extends mxShape {
     ...
     * Paints the swimlane vertex shape.
     */
    paintSwimlane(c: TCanvas2D, x: number, y: number, w: number, h: number, start: number, fill: string, swimlaneLine: boolean) {
        c.begin();
     ...
     * Paints the swimlane vertex shape.
     */
    paintRoundedSwimlane(c: TCanvas2D, x: number, y: number, w: number, h: number, start: number, r: number, fill: string, swimlaneLine: boolean) {
        c.begin();
     ...
     */
    paintDivider(c: TCanvas2D, x: number, y: number, w: number, h: number, start: number, shadow: boolean) {
        if (!shadow) {
            c.setShadow(false);
        }
     ...
     */
    paintSeparator(c: TCanvas2D, x: number, y: number, w: number, h: number, start: number, color: string) {
