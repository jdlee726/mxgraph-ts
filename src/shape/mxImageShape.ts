...
import { mxConstants, HTMLElementMore } from "../util/mxConstants";
...
export default class mxImageShape extends  mxRectangleShape{
    ...
    redrawHtmlShape() {
        ...
        if (this.image != null) {
            ...
            var img = document.createElement((useVml) ? mxClient.VML_PREFIX + ':image' : 'img') as HTMLElementMore;
