...
export default class mxShape {
    ...
    oldGradients: IPlainObject | null;
    ...
    create(container: TElementNode | null = null) {
        ...
        // @ts-ignore
        if (container && container.ownerSVGElement != null) {
    ...
    getLabelBounds(rect: mxRectangle) {
        ...
        var m = this.getLabelMargins(bounds) as unknown as mxRectangle;
    ...
    redrawShape() {
        ...
        if (canvas != null) {
            ...
            if (this.node != canvas.root) {
                ...
                this.node!.insertAdjacentHTML('beforeend', (canvas.root as HTMLElement).outerHTML);
            }
    ...
    updateHtmlFilters(node: TElementNode | null = null) {
        ...
        if (this.fill != null && this.fill != mxConstants.NONE && this.gradient && this.gradient != mxConstants.NONE) {
            ...
            var lookup: IPlainObject = { east: 0, south: 1, west: 2, north: 3 };
    ...
    updateHtmlColors(node?: HTMLElement | SVGElement | null) {
        ...
        if (color != null && color != mxConstants.NONE) {
            ...
            this.setTransparentBackgroundImage(node as SVGElement);
        }
    };
    ...
    paint(c: TCanvas2D, update?: boolean) {
        ...
        if ((this.stencil == null && this.points == null && this.shapePointerEvents) ||
            ...
            if (this.dialect == mxConstants.DIALECT_SVG) {
                ...
                var rect = (c as mxVmlCanvas2D).createRect('rect', bb.x / s, bb.y / s, bb.width / s, bb.height / s);
                rect.appendChild((c as mxVmlCanvas2D).createTransparentFill());
                rect.stroked = 'false';
                c.root!.appendChild(rect as Node);
            }
        }
