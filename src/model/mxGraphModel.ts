...
import { mxSelectionChange } from "../view/mxGraphSelectionModel";
 ...
 */
 ...
 export default class mxGraphModel extends mxEventSource {
 ...
 */
     ...
     * returns true.
     */
    filterCells = (cells: mxCell[], filter: (cell: mxCell)=>boolean) => {
        var result = null;
     ...
     */
     filterDescendants = (filter: null | ((cell: mxCell | null) => boolean), parent: mxCell | null = this.getRoot()) => {
     ...
     */
    isAncestor = (parent: mxCell | null, child: mxCell | null) => {
     ...
     */
    add = (parent: mxCell | null, child: mxCell | null, index?: number) => {
     ...
     cellAdded = (cell: mxCell | null) =>  {
        if (cell) {
            ...
            if (mxUtils.isNumeric(cell.getId())) {
                this.nextId = Math.max(this.nextId, cell.getId() as number);
            }
     ...
     */
    updateEdgeParents = (cell: mxCell | null, root?: mxCell | null) => {
     ...
     */
    updateEdgeParent = (edge: mxCell | null, root: mxCell | null) => {
     ...
     */
    getOrigin = (cell: mxCell | null) => {
        var result = null as unknown as mxPoint;
     ...
     */
    getNearestCommonAncestor = (cell1: mxCell | null, cell2: mxCell | null) => {
     ...
     */
    parentForCellChanged = (cell: mxCell, parent: mxCell | null, index?: number) => {
     ...
     */
    getChildAt = (cell: mxCell | null, index: number) => {
     ...
     */
    getChildEdges = (parent: mxCell | null) => {
     ...
     * Default is false.
     */
    getChildCells = (parent: mxCell | null, vertices = false, edges = false) => {
        var childCount = this.getChildCount(parent);
        var result = [];
     ...
     */
    getTerminal = (edge: mxCell | null, isSource: boolean) => {
     ...
     */
     setTerminal = (edge: mxCell | null, terminal: mxCell | null, isSource: boolean) => {
     ...
     */
     setTerminals = (edge: mxCell | null, source: mxCell | null, target: mxCell | null) => {
        this.beginUpdate();
        try {
     ...
     * target terminal of the edge.
     */
     terminalForCellChanged = (edge: mxCell | null, terminal: mxCell | null, isSource: boolean) => {
     ...
     * to return.
     */
    getEdgeAt =  (cell: mxCell | null, index: number) => {
     ...
     */
     getDirectedEdgeCount = (cell: mxCell | null, outgoing: boolean, ignoredEdge: mxCell | null) => {
        var count = 0;
        var edgeCount = this.getEdgeCount(cell);
     ...
     * 
     */
    getConnections = (cell: mxCell | null) => {
     ...
     * 
     */
    getIncomingEdges = (cell: mxCell | null) => {
     ...
     * 
     */
    getOutgoingEdges = (cell: mxCell | null) => {
     ...
     * Default is true. 
     */
     getEdges = (cell: mxCell | null, incoming = true, outgoing = true, includeLoops = true) => {
     ...
     */
     getEdgesBetween = (source: mxCell | null, target: mxCell | null, directed = false) => {
     ...
     * in the result. Default is true.
     */
     getOpposites = function (edges: mxCell[], terminal: mxCell | null, sources = true, targets = true) {
     ...
     */
     setValue = (cell: mxCell | null, value: any) => {
     ...
     * (end) 
     */
     valueForCellChanged = (cell: mxCell, value: any) => {
     ...
     */
     setGeometry = (cell: mxCell | null, geometry: mxGeometry) => {
     ...
     */
    geometryForCellChanged = (cell: mxCell, geometry: mxGeometry) =>{
     ...
     * the new cell style.
     */
     setStyle = (cell: mxCell, style: string) => {
     ...
     * the new cell style.
     */
     styleForCellChanged = (cell: mxCell, style: string) =>  {
     ...
     * collapsed - Boolean that specifies the new collpased state.
     */
     collapsedStateForCellChanged = (cell: mxCell, collapsed: boolean) => {
     ...
     */
     setVisible = (cell: mxCell, visible: boolean) =>  {
     ...
     * visible - Boolean that specifies the new visible state.
     */
     visibleStateForCellChanged = (cell: mxCell, visible: boolean) => {
    ...
    createUndoableEdit = (significant = true) => {
        var edit = new mxUndoableEdit(this, significant);
     ...
     * source edges.
     */
    mergeChildren = (from: mxCell, to: mxCell, cloneAllEdges = true) => {
        cloneAllEdges = (cloneAllEdges != null) ? cloneAllEdges : true;

        this.beginUpdate();
        try {
            var mapping: IPlainObject = new Object();
     ...
     */
     mergeChildrenImpl = (from: mxCell, to: mxCell, cloneAllEdges = true, mapping: IPlainObject) => {
        this.beginUpdate();
        try {
     ...
     */
    cloneCells = (cells: mxCell[], includeChildren: boolean, mapping?: IPlainObject) => {
     ...
     */
    cloneCellImpl = (cell: mxCell | null, mapping: IPlainObject, includeChildren?: boolean) => {
     ...
     */
    restoreClone = (clone: mxCell | null, cell: mxCell | null, mapping: IPlainObject) => {
...
export class mxChildChange {
     ...
     * cell's terminals.
     */
    connect = (cell: mxCell, isConnect = true) => {
...
export type TChange = mxRootChange | mxChildChange | mxTerminalChange | mxStyleChange | mxValueChange | mxGeometryChange | mxSelectionChange;