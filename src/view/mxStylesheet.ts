...
export default class mxStylesheet {
    ...
    createDefaultVertexStyle =  () => {
        var style: IPlainObject = new Object();
     ...
     */
    putDefaultVertexStyle =  (style: IPlainObject) => {
     ...
     */
    putDefaultEdgeStyle = (style: IPlainObject) => {
     ...
     * style - Key, value pairs that define the style.
     */
    putCellStyle = function (name: string, style: IPlainObject) {
     ...
     */
    getCellStyle = function (name: string, defaultStyle: IPlainObject) {
