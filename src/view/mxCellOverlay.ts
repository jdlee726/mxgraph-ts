 ...
 * (default).
 */
export default class mxCellOverlay extends mxEventSource {
    ...
    constructor(image: mxImage, tooltip = '', align = mxConstants.ALIGN_RIGHT, verticalAlign = mxConstants.ALIGN_BOTTOM, offset = new mxPoint(), cursor = 'help') {
        super();
        this.image = image;
        this.tooltip = tooltip;
        this.align = align || this.align;
        this.verticalAlign = verticalAlign || this.verticalAlign;
        this.offset = offset;
        this.cursor = cursor;
    }
