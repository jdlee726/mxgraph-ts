...
export const mxPerimeter =
{
	 ...
	 * returned.
	 */
    RectanglePerimeter: function (bounds: mxRectangle, vertex: mxCellState, next: mxPoint, orthogonal: boolean) {
	 ...
	 */
    EllipsePerimeter: function (bounds: mxRectangle, vertex: mxCellState, next: mxPoint, orthogonal: boolean) {
        var x = bounds.x;
        var y = bounds.y;
        ...
        var dx = parseInt((px - cx) as any);
        var dy = parseInt((py - cy as any));
	 ...
	 * for a description of the parameters.
	 */
    RhombusPerimeter: function (bounds: mxRectangle, vertex: mxCellState, next: mxPoint, orthogonal: boolean) {
        var x = bounds.x;
        var y = bounds.y;
        var w = bounds.width;
        var h = bounds.height;
	 ...
	 * for a description of the parameters.
	 */
    TrianglePerimeter: function (bounds: mxRectangle, vertex: mxCellState, next: mxPoint, orthogonal: boolean) {
	 ...
	 * for a description of the parameters.
	 */
    HexagonPerimeter: function (bounds: mxRectangle, vertex: mxCellState, next: mxPoint, orthogonal: boolean) {
        var x = bounds.x;
        var y = bounds.y;
        var w = bounds.width;
        var h = bounds.height;
