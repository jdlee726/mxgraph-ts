...
export const mxEdgeStyle =
{
	 ...
	 * edge.
	 */
    EntityRelation: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
        var view = state.view;
    ...
    */
    Loop: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
        var pts = state.absolutePoints;
        ...
        if (source != null) {
            var view = state.view;
            var graph = view!.graph;
            var pt: mxPoint | null = (points != null && points.length > 0) ? points[0] : null;
	 ...
	 * parameters.
	 */
    ElbowConnector: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
	 ...
	 * of the parameters.
	 */
    SideToSide: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
        var view = state.view;
        var pt = (points != null && points.length > 0) ? points[0] : null;
        var pts = state.absolutePoints;
        var p0 = pts[0];
	 ...
	 */
    TopToBottom: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
        var view = state.view;
        var pt = (points != null && points.length > 0) ? points[0] : null;
        var pts = state.absolutePoints;
        var p0 = pts[0];
	 ...
	 */
    SegmentConnector: function (state: mxCellState, source: mxCellState, target: mxCellState, hints: mxPoint[], result: mxPoint[]) {
        ...
        if (hints != null && hints.length > 0) {
            ...
            var currentTerm: mxCellState | null = source;
            var currentPt = pts[0];
            var hozChan = false;
            var vertChan = false;
    ...
    getJettySize: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], isSource: boolean) {
	 ...
	 * 
	 */
    OrthConnector: function (state: mxCellState, source: mxCellState, target: mxCellState, points: mxPoint[], result: mxPoint[]) {
    ...
    getRoutePattern: function (dir: number[], quad: number, dx: number, dy: number) {
        var sourceIndex = dir[0] == mxConstants.DIRECTION_MASK_EAST ? 3
            : dir[0];
        var targetIndex = dir[1] == mxConstants.DIRECTION_MASK_EAST ? 3
            : dir[1];
        ...
        if (dx == 0 || dy == 0) {
            if (mxEdgeStyle.inlineRoutePatterns[sourceIndex - 1][targetIndex - 1] != null) {
                result = mxEdgeStyle.inlineRoutePatterns[sourceIndex - 1][targetIndex - 1]!;
            }
        }
