...
export type TMoveVisitor = (state: mxCellState | null) => void
...
export default class mxCellStatePreview {
     ...
     * Function: moveState
     */
    moveState(state: mxCellState, dx: number, dy: number, add: boolean = true, includeEdges: boolean = true) {
     ...
     */
    translateState(state: mxCellState | null, dx: number, dy: number) {
        if (state != null) {
     ...
     */
    revalidateState(state: mxCellState | null, dx: number, dy: number, visitor?: TMoveVisitor) {
        if (state != null) {
            var model = this.graph.getModel();
