 ...
 */
export default class mxCellState extends mxRectangle {
 ...
 */
    getPerimeterBounds = (border = 0, bounds?: mxRectangle) => {
     ...
     * returned.
     */
    getVisibleTerminal = (source: boolean) => {
     ...
     * returned.
     */
    getVisibleTerminalState = (source: boolean) => {
